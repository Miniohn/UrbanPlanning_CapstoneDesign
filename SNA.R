...
saveWorkbook(example, file="/Users/haley/Desktop/2025-1/Research/data/Korea/data_result/industry_result.xlsx")
...
data_2020_node <-final_2010 %>% rename(label=title) %>% select(id, label, eigen_centrality)
data_2022_node <-final_2010 %>% rename(label=title) %>% select(id, label, eigen_centrality)
